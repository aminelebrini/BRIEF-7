...
<div class="flex flex-col md:flex-row md:items-center md:justify-around md:w-[90%] md:h-[81vh] gap-5 py-10 mx-auto">
    ...
    <div class="w-[100%] flex flex-col justify-center items-center">
        <h1 class="text-[40px] font-bold text-[#3C2877]">About Us</h1>
        <p class="w-[95%] text-[25px] text-[#3C2877] font-100">At NovaCraft Studio, we bring ideas to life through innovative design. As a full-service graphic and UI/UX design agency, we specialize in creating visually stunning and user-friendly experiences that connect brands with their audiences.<br>
